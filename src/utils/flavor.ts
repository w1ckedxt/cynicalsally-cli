...
const FALLBACK: Flavor = {
  ...
  quota_exhausted_ft: "Full Truth requires SuperClub.",
  usage_spinner: "Checking account...",
  usage_sc_greeting: "SuperClub active.",
  ...
  upgrade_already_sc: "Already SuperClub.",
  upgrade_opening: "Opening SuperClub...",
  upgrade_waiting: "Waiting for upgrade...",
  upgrade_success: "SuperClub activated.",
